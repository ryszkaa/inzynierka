...
extern unsigned char one_on[];
extern unsigned char one_off[];
extern unsigned char two_on[];
extern unsigned char two_off[];
extern unsigned char three_on[];
extern unsigned char three_off[];
